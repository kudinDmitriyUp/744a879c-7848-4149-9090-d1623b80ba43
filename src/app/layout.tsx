...
export const metadata: Metadata = {
  title: "CinemaWorks - Professional Video Production Company",
  description: "Create cinematic impact with professional video production. Award-winning team specializing in commercials, documentaries, and corporate content.",
  keywords: "video production, filmmaking, commercial production, cinematography, video services",
  metadataBase: new URL("https://cinemaworks.com"),
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "CinemaWorks - Professional Video Production",
    description: "Transforming visions into compelling visual narratives with cutting-edge technology and creative excellence",
    type: "website",
    siteName: "CinemaWorks",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764789231998-diduguo3.jpg",
  ...
  twitter: {
    ...
    title: "CinemaWorks - Professional Video Production",
    description: "Award-winning video production company specializing in cinematic storytelling",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764789231998-diduguo3.jpg"]
  }
};
